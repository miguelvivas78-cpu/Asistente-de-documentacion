// Auto-generated CIIU Rev 4 A.C. Colombia lookup
// Source: https://github.com/Startup-Colombia/CIIU

export const CIIU_DESCRIPTIONS: Record<string, string> = {
  "0010": "Asalariados",
...
export function getCiiuDescription(code: string): string {
  return CIIU_DESCRIPTIONS[code] || `Actividad económica código ${code}`;
}
